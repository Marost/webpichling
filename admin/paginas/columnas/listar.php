...
header("Content-Type: text/html; charset=utf-8");
	...
	{
		$rst_query=mysql_query("SELECT * FROM pf_columnas WHERE id>0 ORDER BY fecha DESC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM pf_columnas WHERE id>0 ORDER BY fecha DESC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM pf_columnas WHERE titulo LIKE '%$buscar%' ORDER BY fecha DESC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM pf_columnas WHERE titulo LIKE '%$buscar%' ORDER BY fecha DESC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
...
<link rel="stylesheet" type="text/css" href="../../css/style-listas.css">
                      ...
                      <td><table width="95%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        <thead>
                          <tr class="titulo-campo">
                            <th width="60%" height="25">COLUMNAS</th>
                            <th width="20%" align="center">tema</th>
  ...
  ?>
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="20%" align="center"><p><?php echo stripslashes ($fila["tema"]); ?></p></td>
