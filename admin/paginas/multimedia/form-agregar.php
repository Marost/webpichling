...
<div id="contenido">
  <div id="titulo_principal">
   	<h2>Agregar - Sevicios</h2>
  </div><!-- FIN TITULO PRINCIPAL -->
    <div id="contenido_total">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
            	<td>
                <form id="form1" name="form1" method="post" action="../Copia de servicios/guardar.php">
                ...
                <tr>
                  <td colspan="5" align="center"><label> <span class="texto_negro16-MyriadPro">Nombre Menu:</span>
                      <input name="nombre_menu" type="text" id="nombre_menu" size="50" />
                  </label></td>
                </tr>
                <tr>
                  <td colspan="5">&nbsp;</td>
                ...
                <tr>
                  <td colspan="5" align="center"><textarea class="ckeditor" cols="80" id="contenido2" name="contenido" rows="10"></textarea></td>
                </tr>
                <tr>
                  <td colspan="5">&nbsp;</td>
                </tr>
