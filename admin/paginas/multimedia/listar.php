...
include("../../conexion/conexion.php");
	...
	{
		$rst_query=mysql_query("SELECT * FROM ub_servicios WHERE id>0 ORDER BY titulo ASC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM ub_servicios WHERE id>0 ORDER BY nombre_menu ASC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM ub_servicios WHERE nombre_menu LIKE '%$buscar%' ORDER BY nombre_menu ASC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM ub_servicios WHERE nombre_menu LIKE '%$buscar%' ORDER BY nombre_menu ASC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
...
<link rel="stylesheet" type="text/css" href="../../css/style-listas.css">
    ...
    <div id="contenido">
                ...
                <div id="contenido_total">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="28%" height="30" align="center"><form id="form1" name="form1" method="get" action="../Copia de servicios/listar.php">
                        <p>Buscar:
  ...
  ?>
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="50%"><p><?php echo $fila["nombre_menu"]; ?></p></td>
					...
					?></td>
                            <td width="10%" align="center"><a href="../Copia de servicios/form-modificar.php?id=<?php echo $fila["id"] ?>" target="mainFrame"><strong>Modificar</strong></a></td>
                            <td width="10%" align="center"><a href="../Copia de servicios/form-eliminar.php?id=<?php echo $fila["id"] ?>"><strong>Eliminar</strong></a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table></td>
