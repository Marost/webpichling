...
header("Content-Type: text/html; charset=utf-8");
	...
	$rst_query2=mysql_query("SELECT * FROM pf_mundial_post WHERE id=". $_REQUEST["id"] .";", $conexion);
            	      ...
            	      <td height="35" align="left"><span id="spryselect4">
            	        <select name="autor" id="autor">
            	          ...
            	          <?php
								...
								{
									if ($fila["id"]==$fila_query2["autor"])
                                    	echo "<option selected=''  value='". $fila["id"] ."'>". $fila["autor"] ."</option>";
                                	else
            	      ...
            	      <td height="35" align="left"><span id="spryselect">
            	        <select name="grupo" id="grupo">
            	          ...
            	          <?php
								...
								{
									if ($fila1["id"]==$fila_query2["grupo"])
                                    	echo "<option selected=''  value='". $fila1["id"] ."'>". $fila1["grupo"] ."</option>";
                                	else
