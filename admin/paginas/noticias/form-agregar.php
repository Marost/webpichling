            ...
            <tr>
                ...
                <form action="guardar.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            	  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            	    <tr>
            	      <td width="13%" height="45" align="right"><p><strong>Tirulo:</strong></p></td>
            	      <td width="87%" height="45" align="left"><input name="titulo" type="text" id="titulo" title="Ingrese el Titulo que se mostrara en la ficha del Jugador" value="" size="50" /></td>
          	        </tr>
            	    <tr>
            	    ...
            	    <tr>
            	      ...
            	      <td height="25" class="texto_izq"><p>
            	        <input name="fuente" type="text" id="fuente" title="Ingrese el Titulo que se mostrara en la ficha del Jugador" value="" size="50" />
            	      </p></td>
          	        </tr>
            	    <tr>
