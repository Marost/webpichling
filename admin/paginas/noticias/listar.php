...
$buscar=$_REQUEST["busqueda"];
	...
	if ($_REQUEST["btnbuscar"]=="")
	{
		...
		$rst_query=mysql_query("SELECT * FROM pf_noticias WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM pf_noticias WHERE titulo_principal LIKE '%$buscar%' ORDER BY id DESC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM pf_noticias WHERE titulo_principal LIKE '%$buscar%' ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
    ...
    <div id="contenido">
                ...
                <div id="contenido_total">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="28%" height="30" align="center"><form id="form1" name="form1" method="get" action="../entrevistas - Copia/listar.php">
                        <p>Buscar:
                      ...
                      <td><table width="95%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        <thead>
                          <tr class="titulo-campo">
                            <th width="80%" height="25">NOTICIA</th>
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="80%"><p><?php echo stripslashes ($fila["titulo_principal"]); ?></p></td>
