...
header("Content-Type: text/html; charset=utf-8");
	...
	$rst_query=mysql_query("SELECT * FROM pf_columnista WHERE id=". $_REQUEST["id"].";", $conexion);
	$fila_query=mysql_fetch_array($rst_query);
	
	$rst_query2=mysql_query("SELECT * FROM pf_columnas WHERE id_autor=". $_REQUEST["id"].";", $conexion);
        ...
        <div id="contenido-izq">
         <div id="entrevista">
       	  <div class="texto-blanco28-ArialBlack" id="cabecera-titulo">
                	<?php echo $fila_query["tema"] ?>
                </div><!--FIN CABECERA TITULO -->
                <div id="contenido-entrevista">
       	    	  <?php while($fila=mysql_fetch_array($rst_query2)){ ?>
                      <div class="texto_fnd-plomo_negro" id="texto-entrevista-inf">
                        <a href="columnas.php?id=<?php echo $fila["id"] ?>" title="Da clic para leer el articulo"><?php echo $fila["titulo"] ?></a>
