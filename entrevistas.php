...
header("Content-Type: text/html; charset=utf-8");
	...
	$rst_query=mysql_query("SELECT * FROM pf_entrevista_mes WHERE id>0 ORDER BY id DESC", $conexion);
  ...
  <tr>
    ...
    <td width="950" class="contenido-pasto">
        ...
        <div id="contenido-izq">
          <div id="entrevista">
              <div class="texto-blanco28-ArialBlack" id="cabecera-titulo">ENTREVISTAS</div><!--FIN CABECERA TITULO -->
          </div>
          
    		<div id="entrevista">
            <br />            
				<?php while($fila_query=mysql_fetch_array($rst_query)){ ?>
                <div class="texto-blanco22-ArialBlack" id="cabecera-titulo"><a href="post-entrevista.php?id=<?php echo $fila_query["id"] ?>"> <?php echo $fila_query["nombre"] ?></a></div><!--FIN CABECERA TITULO -->
                <div id="contenido-entrevista">
                    <div id="imagen-entrevista"><img src="imagenes/upload/escala150.php?imagen=<?php echo $fila_query["foto"] ?>" alt="" /></div><!--FIN IMAGEN ENTREVISTA -->
                    <div class="texto_fnd-plomo_negro" id="texto-entrevista-der"><?php echo $fila_query["texto_corto"] ?></div><!--FIN TEXTO ENTREVISTA DERECHA -->
