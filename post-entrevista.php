       	  ...
       	  <div class="texto-blanco22-ArialBlack" id="cabecera-titulo">
                ...
                <div id="contenido-entrevista">
                    ...
                    <div class="texto_fnd-plomo_negro" id="texto-entrevista-der"><?php echo $fila_query["texto_corto"] ?></div><!--FIN TEXTO ENTREVISTA DERECHA -->
               	  <div class="texto_fnd-plomo_negro" id="texto-entrevista-inf"><?php echo $fila_query["contenido"] ?></div><!--FIN TEXTO ENTREVISTA INFERIOR -->
                </div><!--FIN CONTENIDO ENTREVISTA -->
          </div><!--FIN ENTREVISTA -->
          <div class="espacio680"></div><!--FIN COLUMNISTAS --><!--FIN COLUMNISTAS --><!--FIN COLUMNISTAS --><!--FIN COLUMNISTAS -->
